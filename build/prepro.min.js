    ...
    value: function showFrameDetails(frame) {
      for (var serviceName in frame) {
        ...
        if (!this.servicesViews_[serviceName]) {
          var ServiceViewClass = __webpack_require__(34)("./" + serviceName + '/view');
          if (!ServiceViewClass) {
            continue;
          }
    ...
    value: function setup(data) {
      for (var s in data) {
        if (services.indexOf(s) != -1) {
          var ServiceClass = __webpack_require__(31)("./" + s + '/service');
