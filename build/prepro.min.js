...
var _debug_view = __webpack_require__(3);
...
var Prepro = function (_EventDispatcher) {
  ...
  _createClass(Prepro, [{
    ...
    value: function load(folder) {
      ...
      return new Promise(function (resolve, reject) {
        fetch(folder + '/' + DEFAULT_CONFIG_FILENAME).then(function (data) {
          ...
          _this2.video.addEventListener('update', _this2.dispatch.bind(_this2));
    ...
    value: function addDebugView(el) {
      this.view = new _debug_view2.default(this.video, el || document.body);
    }
...
var _flow = __webpack_require__(6);

var _flow2 = _interopRequireDefault(_flow);

var _openpose = __webpack_require__(8);

var _openpose2 = _interopRequireDefault(_openpose);

var _segmentation = __webpack_require__(10);

var _segmentation2 = _interopRequireDefault(_segmentation);

var _sift = __webpack_require__(29);

var _sift2 = _interopRequireDefault(_sift);

var _spectrogram = __webpack_require__(12);
    ...
    value: function showFrameDetails(frame) {
      for (var serviceName in frame) {
        ...
        if (!this.servicesViews_[serviceName]) {
          var ServiceViewClass = viewClasses[serviceName];
          if (!ServiceViewClass) {
            continue;
          }
...
function loadAll(folder, config) {
  return new Promise(function (resolve, reject) {
    ...
    var loaders = config.services.map(function (s) {
      ...
      if (['openpose', 'colors', 'spectrogram', 'flow', 'segmentation', 'sift'].indexOf(name) == -1) {
        return;
      }
      switch (s.type) {
        case 'json':
...
var _flow = __webpack_require__(18);

var _flow2 = _interopRequireDefault(_flow);

var _openpose = __webpack_require__(19);

var _openpose2 = _interopRequireDefault(_openpose);

var _segmentation = __webpack_require__(20);

var _segmentation2 = _interopRequireDefault(_segmentation);

var _sift = __webpack_require__(28);

var _sift2 = _interopRequireDefault(_sift);

var _spectrogram = __webpack_require__(21);
  ...
  _createClass(Flow, [{
    ...
    set: function set(video) {
      ...
      var drawNextFrame = function drawNextFrame() {
        var ctx = _this.frames[_this.currLoaded_];
        ctx.drawImage(_this.video_, 0, 0, ctx.canvas.width, ctx.canvas.height);
        _this.currLoaded_++;
        if (_this.currLoaded_ >= numFrames) {
          _this.video_.removeEventListener('seeked', drawNextFrame);
        } else {
          _this.video_.currentTime = _this.currLoaded_ / prepro.config.framerate;
        }
      };
