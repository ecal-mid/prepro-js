...
var _openpose = __webpack_require__(6);
...
var Prepro = function () {
  function Prepro(el) {
    ...
    if (el) {
      this.el = el;
      this.view = new _view2.default(this.el);
    }
  }
  ...
  _createClass(Prepro, [{
      ...
      return new Promise(function (resolve, reject) {
        fetch(folder + '/' + DEFAULT_CONFIG_FILENAME).then(function (data) {
          ...
          (0, _loader2.default)(folder, config).then(function (data) {
            ...
            if (_this.view) {
              _this.view.setup(folder + '/' + DEFAULT_VIDEO_FILENAME, config);
            }
            resolve();
          }).catch(reject);
        });
    ...
    value: function getCurrentFrame() {
      ...
      var servicesNames = this.config.services.map(function (s) {
        return s.name;
      });
      ...
      try {
        for (var _iterator = servicesNames[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
with (obj) {
__p += '<h1 class="prepro-title">Colors</h1>\n<div class="prepro-palette">\n';
