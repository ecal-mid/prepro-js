...
function loadAll(folder, config) {
  return new Promise(function (resolve, reject) {
    ...
    var loaders = config.services.map(function (s) {
      ...
      var services = config.services_filter || ['openpose', 'colors', 'spectrogram', 'flow', 'segmentation', 'sift', 'depth'];
 ...
 * @private
 */
var services = ['colors', 'openpose', 'spectrogram', 'flow', 'segmentation', 'sift', 'depth'];
    ...
    value: function setup(data) {
      ...
      for (var s in data) {
        if (services.indexOf(s) != -1) {
          var ServiceClass = __webpack_require__(22)("./" + s + '/service');
...
var map = {
	...
	"./flow/service": 25,
	"./openpose/service": 26,
	"./segmentation/service": 27,
	"./sift/service": 28,
	"./spectrogram/service": 29
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
};
