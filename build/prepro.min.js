...
var _openpose = __webpack_require__(7);

var _openpose2 = _interopRequireDefault(_openpose);

var _segmentation = __webpack_require__(23);

var _segmentation2 = _interopRequireDefault(_segmentation);

var _spectrogram = __webpack_require__(9);
...
function loadAll(folder, config) {
  return new Promise(function (resolve, reject) {
    ...
    var loaders = config.services.map(function (s) {
      ...
      if (['openpose', 'colors', 'spectrogram', 'flow', 'segmentation'].indexOf(name) == -1) {
        return;
      }
      switch (s.type) {
        case 'json':
...
var _flow = __webpack_require__(15);

var _flow2 = _interopRequireDefault(_flow);

var _openpose = __webpack_require__(16);

var _openpose2 = _interopRequireDefault(_openpose);

var _segmentation = __webpack_require__(25);

var _segmentation2 = _interopRequireDefault(_segmentation);

var _spectrogram = __webpack_require__(17);
...
var Services = function () {
  ...
  _createClass(Services, [{
    ...
    key: 'getFrame',
    value: function getFrame(frameNum) {
