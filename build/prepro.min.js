...
var DepthView = function () {
  function DepthView(container) {
    _classCallCheck(this, DepthView);
    ...
    var itvl = setInterval(function () {
      var service = prepro.services.get('depth');
...
var BoxDetectionView = function () {
  function BoxDetectionView(container) {
    _classCallCheck(this, BoxDetectionView);
    ...
    value: function show(data) {
      ...
      try {
        for (var _iterator = data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          ctx.lineWidth = 8;
          ctx.beginPath();
          ctx.rect(box.x * w, box.y * h, (box.x + box.width) * w, (box.y + box.height) * h);
          ctx.stroke();
...
var __t, __p = '';
with (obj) {
__p += '<h1 class="prepro-title">Object Detection</h1>\n<canvas class="object-detection" width="' +
((__t = ( config.width )) == null ? '' : __t) +
'" height="' +
((__t = ( config.height )) == null ? '' : __t) +
'"></canvas>\n';
...
function loadAll(folder, config) {
  return new Promise(function (resolve, reject) {
    ...
    var loaders = config.services.map(function (s) {
      ...
      var services = config.services_filter || ['openpose', 'colors', 'spectrogram', 'flow', 'segmentation', 'sift', 'depth', 'detection'];
 ...
 * @private
 */
var services = ['colors', 'openpose', 'spectrogram', 'flow', 'segmentation', 'sift', 'depth', 'detection'];
    ...
    value: function setup(data) {
      ...
      for (var s in data) {
        if (services.indexOf(s) != -1) {
          var ServiceClass = __webpack_require__(24)("./" + s + '/service');
...
var map = {
	"./colors/service": 25,
	"./depth/service": 26,
	"./detection/service": 27,
	"./flow/service": 28,
	"./openpose/service": 29,
	"./segmentation/service": 30,
	"./sift/service": 31,
	"./spectrogram/service": 32
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
};
 ...
 */
var Depth = function (_BaseService) {
  _inherits(Depth, _BaseService);

  function Depth() {
    _classCallCheck(this, Depth);

    return _possibleConstructorReturn(this, (Depth.__proto__ || Object.getPrototypeOf(Depth)).apply(this, arguments));
  }
 ...
 */
var Detection = function (_BaseService) {
  _inherits(Detection, _BaseService);

  function Detection() {
    _classCallCheck(this, Detection);

    return _possibleConstructorReturn(this, (Detection.__proto__ || Object.getPrototypeOf(Detection)).apply(this, arguments));
  }
